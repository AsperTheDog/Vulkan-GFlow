...
void VulkanContext::init(const uint32_t vulkanApiVersion, const bool enableValidationLayers,
...
uint32_t VulkanContext::createDevice(const VulkanGPU gpu, const QueueFamilySelector& queues,
                                     const std::vector<const char*>& extensions,
