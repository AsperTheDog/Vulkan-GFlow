...
void VulkanPipelineBuilder::setInputAssemblyState(const VkPrimitiveTopology topology,
...
void VulkanPipelineBuilder::setViewportState(const std::vector<VkViewport>& viewports,
...
void VulkanPipelineBuilder::setRasterizationState(const VkPolygonMode polygonMode, const VkCullModeFlags cullMode,
...
void VulkanPipelineBuilder::setMultisampleState(const VkSampleCountFlagBits rasterizationSamples,
...
void VulkanPipelineBuilder::setDepthStencilState(const VkBool32 depthTestEnable, const VkBool32 depthWriteEnable,
...
void VulkanPipelineBuilder::setColorBlendState(const VkBool32 logicOpEnable, const VkLogicOp logicOp,
                                               const std::array<float, 4> colorBlendConstants)
{
...
VulkanPipeline::VulkanPipeline(VulkanDevice& device, const VkPipeline handle, const uint32_t layout,
