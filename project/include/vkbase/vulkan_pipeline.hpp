...
struct VulkanPipelineBuilder
{
    ...
    void setRasterizationState(VkPolygonMode polygonMode, VkCullModeFlags cullMode = VK_CULL_MODE_BACK_BIT,
                               VkFrontFace frontFace = VK_FRONT_FACE_CLOCKWISE);

    void setMultisampleState(const VkPipelineMultisampleStateCreateInfo& state);
    void setMultisampleState(VkSampleCountFlagBits rasterizationSamples, VkBool32 sampleShadingEnable = VK_FALSE,
